...
export default function CatalogPage() {
  ...
  const { data: productsData, isLoading: productsLoading, error: productsError } = useProducts({
    ...
    sort: sortBy === 'popular' ? undefined : sortBy, // API не поддерживает 'popular'
    page: currentPage,
    limit: 24,
  });
          ...
          >
            ...
            <div className="cat-tree" style={{ borderBottom: '1px solid var(--gray1)' }}>
              ...
              <button
                ...
                className={`cat-tree__item ${!selectedCategory ? 'is-active' : ''}`}
                style={{
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'space-between',
                  padding: '9px 16px',
                  fontSize: '13px',
                  color: !selectedCategory ? 'var(--orange)' : 'var(--gray4)',
                  background: !selectedCategory ? 'var(--black3)' : 'transparent',
                  borderLeftWidth: !selectedCategory ? '2px' : '0',
                  borderLeftStyle: !selectedCategory ? 'solid' : 'none',
                  borderLeftColor: !selectedCategory ? 'var(--orange)' : 'transparent',
                  border: 'none',
                  cursor: 'pointer',
              ...
              {categoriesLoading ? (
                ...
                categories.map((cat) => (
                  <button
                    ...
                    className={`cat-tree__item ${selectedCategory === cat.slug ? 'is-active' : ''}`}
                    style={{
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'space-between',
                      padding: '9px 16px',
                      fontSize: '13px',
                      color: selectedCategory === cat.slug ? 'var(--orange)' : 'var(--gray4)',
                      background: selectedCategory === cat.slug ? 'var(--black3)' : 'transparent',
                      borderLeftWidth: selectedCategory === cat.slug ? '2px' : '0',
                      borderLeftStyle: selectedCategory === cat.slug ? 'solid' : 'none',
                      borderLeftColor: selectedCategory === cat.slug ? 'var(--orange)' : 'transparent',
                      border: 'none',
                      cursor: 'pointer',
                      transition: 'background var(--tr), color var(--tr)',
                      width: '100%',
                ...
                {products.map((product) => (
                  ...
                  >
                    ...
                    <div className="product-row__body">
                      <div
                        className="stars"
                        style={{ fontSize: '11px', marginBottom: '6px', color: 'var(--orange)' }}
                      >
                        {product.rating}{' '}
                        <span
                          className="rating-count"
                          style={{ color: 'var(--gray3)', marginLeft: '4px' }}
                        >
                          ({product.reviewsCount})
                        </span>
                      </div>
                      ...
                      >
                        <span
                          className="product-row__spec"
                          style={{ fontSize: '11px', color: 'var(--gray3)' }}
                        >
                          {product.brand?.name}
                        </span>
                      </div>
                    ...
                    <div
                      className="product-row__actions"
                      style={{
                        display: 'flex',
                        flexDirection: 'column',
                        alignItems: 'flex-end',
                    ...
                    >
                      <div className="product-row__price-block">
                        <div
                          className="price"
                          style={{
                            fontFamily: 'var(--font-display)',
